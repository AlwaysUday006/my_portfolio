        ...
        >
          {certifications.map((cert) => (
            <motion.div
              ...
              className="glassmorphism rounded-2xl overflow-hidden flex flex-col justify-between hover:border-cyan-500/30 hover:bg-white/5 transition-all duration-500 group shadow-xl"
            >
              {/* Image Frame */}
              <div className="relative aspect-[16/11] overflow-hidden bg-slate-900 border-b border-white/5">
                ...
                <button
                  ...
                  className="absolute inset-0 bg-[#07070a]/60 backdrop-blur-xs flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 cursor-pointer"
                  aria-label={`Enlarge ${cert.title} image`}
                >
                  <div className="w-12 h-12 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-white scale-90 group-hover:scale-100 transition-transform duration-300">
